    ...
    for sentence in selected_sentences:
        ...
        if noun_counts:
            ...
            while len(distractors) < 3:
                distractors.append(random.choice(nouns))  # Select random nouns as distractors
            ...
            correct_answer_letter = chr(97 + correct_answer_index)  # Convert index to letter (a, b, c, d)
